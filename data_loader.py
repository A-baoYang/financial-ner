...
processors = {
    ...
    "msra": JointPrecessor,
    "people_daily": JointPrecessor,
    "ltn_news": JointPrecessor,
    "gpt35": JointPrecessor,
    "gpt35_filtered": JointPrecessor,
}
...
def load_and_cache_examples(args, tokenizer, mode):  # mode=train/dev/test
    ...
    if os.path.exists(cached_features_file):
        ...
        features = convert_examples_to_features(
            examples, args.max_seq_len, tokenizer, pad_token_label_id
        )
