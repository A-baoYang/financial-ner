...
class JointBERT(BertPreTrainedModel):
    def __init__(self, bert_config, args, slot_label_lst):
        ...
        if args.do_pred:
            self.lm = PRETRAINED_MODEL_MAP[args.model_type](config=bert_config)
        else:
            self.lm = PRETRAINED_MODEL_MAP[args.model_type].from_pretrained(args.model_name_or_path, config=bert_config, from_tf=False, from_flax=False)
